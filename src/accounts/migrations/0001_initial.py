    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to=src.accounts.models.get_img_path, verbose_name='User image')),
                ('phone_number', models.CharField(max_length=15, unique=True, verbose_name='Phone number')),
                ('birth_at', models.DateField(blank=True, null=True, verbose_name='Birthday')),
